...
func TestStripANSI(t *testing.T) {
	tests := []struct {
		...
		// Real GORM line from the wellprepped trial (runbook, 2026-08-08).
		{"gorm red line",
			"2026/08/08 22:18:20 \x1b[31;1mgithub.com/wellprepped/connect-api/internal/repositories/learning/feedback/repo.go:22 \x1b[35;1mrecord not found",
			"2026/08/08 22:18:20 github.com/wellprepped/connect-api/internal/repositories/learning/feedback/repo.go:22 record not found",
			true},
...
// Real line shapes from the wellprepped trial corpus (runbook).
var sampleLines = []string{
	`104.23.160.143 - - [08/Aug/2026:22:26:49 +0000] "POST /webhooks/daily HTTP/2.0" 401 29 "-" "-" 87794 "connect-api@swarm" "http://10.0.1.125:8080" 1ms`,
	`108.162.246.84 - - [08/Aug/2026:21:59:01 +0000] "POST /api/webhooks/daily HTTP/2.0" 404 18 "-" "-" 87050 "connect-api@swarm" "http://10.0.1.126:8080" 1ms`,
...
**Interfaces:**
- Consumes: the CLI from Task 4; the trial deployment's `agenterr.db` on the wellprepped box (tailnet).
...
**Run:** <date> against corpus <window>, <N> logs (wellprepped trial box).
